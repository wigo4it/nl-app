...
namespace NLappCMS.Models.Extract
{
    /// <summary>
    /// The property extract base.
    /// </summary>
    public abstract class PropertyExtractBase
    {
        ...
        /// The language.
        /// </param>
        public virtual void Examine(StringBuilder extractedContent,IPublishedContent content,string alias,string language = null)
        {
